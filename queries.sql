...
SELECT * FROM employees
WHERE first_name or last_name not in ('John', 'Mark', 'Jacob');
...
/*How many managers do we have in the “employees” database? If possible Use the star symbol (*) to solve this exercise.*/
SELECT COUNT(title) FROM titles tit, employees emp
WHERE tit.emp_no = emp.emp_no and title= 'Senior Staff'; 
